  ...
  return (
    <main>
      <MainPadding>
        ...
        <section className="flex items-centers gap-8 border-b-2 w-fit p-4 max-lg:flex-col">
          ...
          <button>
            <img
              className="ms-16 h-6 max-lg:mx-auto"
              src={trashCanIcon}
              alt=""
            />
          </button>
        ...
        <section>
          <h1 className="text-2xl font-bold my-8 max-lg:text-center">
            المتنجات
          </h1>
          {/* TODO DELETE LOOP */}
          {temp.map((index) => (
